...
class CheckPage{
	...
	public function isAuthor(){
		...
		$tmp['function'] 	= 'is_archive() -> is_author()';
		$tmp['page'] 		= 'index.php -> archive.php -> author.php -> '
							  . 'author-'. $userID .'.php-> author-' . $userInfo->data->user_nicename . '.php';
