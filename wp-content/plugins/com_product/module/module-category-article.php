<?php
class ModuleCategoryArticle extends WP_Widget {

	public function __construct() {		
		$id_base = 'module-category-article';
		$name	= 'ModuleCategoryArticle';
		$widget_options = array(
					'classname' => 'module-category-article',
					'description' => 'ModuleCategoryArticle'
				);
	...
	public function widget( $args, $instance ) {			
		...
		require PLUGIN_PATH . DS . 'module'. DS .'html'. DS .'module-category-article.php';		
		echo $after_widget;						
	}
