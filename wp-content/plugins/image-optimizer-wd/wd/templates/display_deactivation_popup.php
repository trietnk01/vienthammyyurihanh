    ...
    <form method="post" id="<?php echo $wd_options->prefix; ?>_deactivate_form">
            ...
            <?php foreach ($deactivate_reasons as $deactivate_reason_slug => $deactivate_reason) { ?>
                <div class="wd-<?php echo $wd_options->prefix; ?>-reasons">
                    <input type="radio" value="<?php echo $deactivate_reason["id"]; ?>"
                           id="<?php echo $wd_options->prefix . "-" . $deactivate_reason["id"]; ?>"
                           name="<?php echo $wd_options->prefix; ?>_reasons">
        ...
        <div class="wd-btns">
            <a href="<?php echo $deactivate_url; ?>" data-val="1"
               ...
               id="wd-<?php echo $wd_options->prefix; ?>-deactivate"><?php _e("Deactivate", $wd_options->prefix); ?></a>
